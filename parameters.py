...
par = {
    # Setup parameters
    'save_dir'              : 'C:/Users/Krithika/Documents/Freedmanlab_reading list_papers/RNNs/intdmc_rnn/',
    'debug_model'           : False,
    'load_previous_model'   : False,
    'analyze_model'         : False,

    # Network configuration
    'synapse_config'        : 'std_stf',   # Full is 'std_stf', 'stf', 'stf', or None
    ...
    'num_motion_dirs'       : 10,
    'tuning_height'         : 1,        # magnitude scaling factor for von Mises
...
def update_dependencies():
    ...
    if par['trial_type'] == 'spatial_cat':
        ...
        par['n_input'] = par['num_color_tuned'] + par['num_fix_tuned'] + par['num_spatial_tuned'] + par['num_rule_tuned']
    elif par['trial_type'] == 'OIC' or par['trial_type'] == 'DMC' or par['trial_type']=='OICDMC':
    ...
    if par['synapse_config'] == None:
        ...
        par['w_rnn0'][:, par['num_exc_units']:] *= 2
        par['w_rnn0'][par['num_exc_units']:,:] *= 2
...
def initialize(dims, connection_prob):
    w = np.random.gamma(shape=0.1, scale=1.0, size=dims)
